...
const routes: Routes = [
  ...
  { path: 'nativescript-cloudinary', loadChildren: () => import('./plugin-demos/nativescript-cloudinary.module').then((m) => m.NativescriptCloudinaryModule) },
  ...
  { path: 'nativescript-toolbar', loadChildren: () => import('./plugin-demos/nativescript-toolbar.module').then((m) => m.NativescriptToolbarModule) },
