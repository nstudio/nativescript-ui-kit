...
@objc public class SidebarViewController: UIViewController {
    ...
    private func createLayout() -> UICollectionViewLayout {
        return UICollectionViewCompositionalLayout { section, layoutEnvironment in
            if #available(iOS 14.0, *) {
                ...
                return NSCollectionLayoutSection.init(group: NSCollectionLayoutGroup.init(layoutSize: NSCollectionLayoutSize.init(widthDimension: NSCollectionLayoutDimension.absolute(300), heightDimension: NSCollectionLayoutDimension.absolute(300))))
            }
        }
    }
