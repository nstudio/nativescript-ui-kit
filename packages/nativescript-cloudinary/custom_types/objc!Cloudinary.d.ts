...
declare class CLDAnalytics extends NSObject {
  static alloc(): CLDAnalytics; // inherited from NSObject

  static new(): CLDAnalytics; // inherited from NSObject

  constructor(o: { sdkVersion: string; techVersion: string; osType: string; osVersion: string; featureFlag: string });

  generateAnalyticsSignatureWithSdkVersionTechVersionOsTypeOsVersionFeatureFlag(sdkVersion: string, techVersion: string, osType: string, osVersion: string, featureFlag: string): string;

  initWithSdkVersionTechVersionOsTypeOsVersionFeatureFlag(sdkVersion: string, techVersion: string, osType: string, osVersion: string, featureFlag: string): this;

  setFeatureFlagWithFlag(flag: string): void;

  setOsVersionWithVersion(version: string): void;

  setSDKVersionWithVersion(version: string): void;

  setTechVersionWithVersion(version: string): void;
}
...
declare class CLDCloudinary extends NSObject {
  ...
  setExtraHeaderes(extraHeaders: NSDictionary<string, string>): void;
...
declare class CLDConfiguration extends NSObject {
  ...
  readonly signatureVesion: number;

  readonly timeout: number;

  readonly uploadPrefix: string;

  constructor(o: { cloudName: string; apiKey: string; apiSecret: string; privateCdn: boolean; secure: boolean; cdnSubdomain: boolean; secureCdnSubdomain: boolean; longUrlSignature: boolean; signatureAlgorithm: SignatureAlgorithm; signatureVersion: number; secureDistribution: string; cname: string; uploadPrefix: string; timeout: number; analytics: boolean });

  constructor(o: { cloudinaryUrl: string });

  constructor(o: { options: NSDictionary<string, any> });

  initWithCloudNameApiKeyApiSecretPrivateCdnSecureCdnSubdomainSecureCdnSubdomainLongUrlSignatureSignatureAlgorithmSignatureVersionSecureDistributionCnameUploadPrefixTimeoutAnalytics(cloudName: string, apiKey: string, apiSecret: string, privateCdn: boolean, secure: boolean, cdnSubdomain: boolean, secureCdnSubdomain: boolean, longUrlSignature: boolean, signatureAlgorithm: SignatureAlgorithm, signatureVersion: number, secureDistribution: string, cname: string, uploadPrefix: string, timeout: number, analytics: boolean): this;
...
declare class CLDManagementApi extends CLDBaseNetworkObject {
  ...
  addTagsPublicIdsParamsCompletionHandler(tag: NSArray<string> | string[], publicIds: NSArray<string> | string[], params: CLDTagsRequestParams, completionHandler: (p1: CLDTagResult, p2: NSError) => void): CLDTagRequest;
  ...
  removeTagsPublicIdsParamsCompletionHandler(tag: NSArray<string> | string[], publicIds: NSArray<string> | string[], params: CLDTagsRequestParams, completionHandler: (p1: CLDTagResult, p2: NSError) => void): CLDTagRequest;
  ...
  replaceTagsPublicIdsParamsCompletionHandler(tag: NSArray<string> | string[], publicIds: NSArray<string> | string[], params: CLDTagsRequestParams, completionHandler: (p1: CLDTagResult, p2: NSError) => void): CLDTagRequest;
...
declare class CLDRenameResult extends CLDBaseResult {
  ...
  readonly metadataObject: NSDictionary<string, string>;
...
declare class CLDRequestParams extends NSObject {
  ...
  setApiKeyWithKey(apiKey: string): this;

  setParamValue(key: string, value: any): this;

  setResourceTypeFromString(resourceType: string): this;

  setResourceTypeFromUrlResourceType(resourceType: CLDUrlResourceType): this;

  setSignatureWithSignature(signature: CLDSignature): this;
}
...
declare class CLDTransformation extends NSObject {
  ...
  setEndOffsetFromExpression(input: CLDExpression): this;
  ...
  setStartOffsetFromExpression(input: CLDExpression): this;
...
declare class CLDUploadRequestParams extends CLDRequestParams {
  ...
  readonly backgroundRemoval: string;
  ...
  setAssetFolder(assetFolder: string): this;

  setAsync(async: boolean): this;

  setAutoChpatering(autoChaptering: boolean): this;

  setAutoTagging(autoTagging: string): this;

  setAutoTaggingWithDouble(autoTagging: number): this;

  setAutoTranscription(autoTranscription: boolean): this;

  setBackgroundRemoval(backgroundRemoval: string): this;
  ...
  setFilenameOverride(filenameOverride: string): this;
  ...
  setMediaMetadata(mediaMetadata: boolean): this;
  ...
  setPublicIdPrefix(prefix: string): this;
  ...
  setUseFilenameAsDisplayName(useFilenameAsDisplayName: boolean): this;
}
 ...
 * @since 10.0
 */
declare class CLDVideoPlayer extends AVPlayer {
  static alloc(): CLDVideoPlayer; // inherited from NSObject

  static new(): CLDVideoPlayer; // inherited from NSObject

  static playerWithPlayerItem(item: AVPlayerItem): CLDVideoPlayer; // inherited from AVPlayer

  static playerWithURL(URL: NSURL): CLDVideoPlayer; // inherited from AVPlayer

  constructor(o: { url: string });

  flushEvents(): void;

  flushEventsAndCloseSession(): void;

  initWithUrl(string: string): this;

  setProvidedDataWithData(data: NSDictionary<string, any>): void;
}
