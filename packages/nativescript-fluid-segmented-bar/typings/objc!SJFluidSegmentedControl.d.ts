declare class SJFluidSegmentedControl extends UIView implements UIGestureRecognizerDelegate, UIScrollViewDelegate {
  ...
  static appearanceForTraitCollectionWhenContainedIn(trait: UITraitCollection, ContainerClass: typeof NSObject): SJFluidSegmentedControl; // inherited from UIAppearance

  static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | (typeof NSObject)[]): SJFluidSegmentedControl; // inherited from UIAppearance

  static appearanceWhenContainedIn(ContainerClass: typeof NSObject): SJFluidSegmentedControl; // inherited from UIAppearance

  static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject> | (typeof NSObject)[]): SJFluidSegmentedControl; // inherited from UIAppearance
...
interface SJFluidSegmentedControlDataSource {
  ...
  segmentedControlAttributedTitleForSegmentAtIndex?(segmentedControl: SJFluidSegmentedControl, index: number): NSAttributedString;

  segmentedControlAttributedTitleForSelectedSegmentAtIndex?(segmentedControl: SJFluidSegmentedControl, index: number): NSAttributedString;
  ...
  segmentedControlTitleColorForSelectedSegmentAtIndex?(segmentedControl: SJFluidSegmentedControl, index: number): UIColor;
...
interface SJFluidSegmentedControlDelegate {
  ...
  segmentedControlResetSegmentAtIndexUnselectedViewSelectedView?(segmentedControl: SJFluidSegmentedControl, segmentIndex: number, unselectedSegmentView: UIView, selectedSegmentView: UIView): void;

  segmentedControlSetupSegmentAtIndexUnselectedViewSelectedViewWithSelectionPercent?(segmentedControl: SJFluidSegmentedControl, segmentIndex: number, unselectedSegmentView: UIView, selectedSegmentView: UIView, percent: number): void;
...
declare class SJGradientView extends UIView {
  ...
  static appearanceForTraitCollectionWhenContainedIn(trait: UITraitCollection, ContainerClass: typeof NSObject): SJGradientView; // inherited from UIAppearance

  static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | (typeof NSObject)[]): SJGradientView; // inherited from UIAppearance

  static appearanceWhenContainedIn(ContainerClass: typeof NSObject): SJGradientView; // inherited from UIAppearance

  static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject> | (typeof NSObject)[]): SJGradientView; // inherited from UIAppearance
